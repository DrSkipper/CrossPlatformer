...
namespace Assets.Scripts
{
    struct InputState
    {
        ...
        public static InputState GetInputStateForPlayer(int playerIndex)
        {
            ...
            state.Shoot = Input.GetButton("Fire1");
            state.ShootStarted = Input.GetButtonDown("Fire1");
            state.Dodge = Input.GetButton("Fire2");
            state.DodgeStarted = Input.GetButtonDown("Fire2");
            state.AmmoSwitch = Input.GetButton("Fire3");
            state.AmmoSwitchStarted = Input.GetButtonDown("Fire3");
